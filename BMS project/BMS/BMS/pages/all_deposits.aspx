<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all_deposits.aspx.cs" Inherits="BMS.pages.all_deposits" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>all deposits - Bank Management System</title>
...
<div id="client_area" style="position:relative; top:-567px; left:42px; width:755px; height:542px;">
    ...
    <h3 style="background-color: #9999FF; width: 716px; height: 25px;">عرض كافة الايداعات</h3>
</div>
     <table>
        <tr>
            <td>
                <asp:GridView ID="dgvdep" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="716px" Height="228px">
