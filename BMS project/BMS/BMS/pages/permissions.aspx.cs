...
retriving.functions.save("insert into permissions (username,password,accountant,transfer,makesure,cards,employees) values ('" + txtuser.Text + "','" + txtpass.Text + "','" +  acc.Checked.ToString() + "','" +  trns.Checked.ToString() + "','" +  box.Checked.ToString() + "','" +  cards.Checked.ToString() + "','" +  emp.Checked.ToString() + "')");
