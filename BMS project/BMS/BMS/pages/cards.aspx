<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cards.aspx.cs" Inherits="BMS.pages.cards" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>Cards - Bank Management System</title>
...
<div style="text-align:center;">
    <h3 style="background-color: #9999FF; width: 403px; height: 25px;">إصدار بطاقة</h3>
</div>
<table style="Width:405px; text-align: center; background-color: #99FF66;">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txttype" runat="server" Width="243px"></asp:TextBox></td>
            <td>نوع البطاقة</td>
        </tr>
        <tr>
             <td><asp:Label ID="lbldaterec" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:TextBox ID="txtdaterec" runat="server" Width="243px"></asp:TextBox></td>
            <td>تاريخ الاستلام</td>
        </tr>
        <tr>
           <td></td>
            <td><asp:Button ID="btnsend" runat="server" Text="حفظ" Width="97px" OnClick="btnsend_Click" style="height: 26px"/></td>
        </tr>   
                <tr>
            <td></td>
