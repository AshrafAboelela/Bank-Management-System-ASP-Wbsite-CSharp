<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="withdrwals.aspx.cs" Inherits="BMS.pages.withdrwals" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>withdrwals - Bank Management System</title>
...
<div style="text-align:center;">
    <h3 style="background-color: #9999FF; width: 403px; height: 25px;">إجراء حركة سحب</h3>
</div>

<table style="Width:405px; text-align: center; background-color: #99FF66;">
        <tr>
            <td><asp:Label ID="lblwithamountno" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False" ></asp:Label></td>
             <td><asp:TextBox ID="txtwithamountno" runat="server" Width="280px"></asp:TextBox></td>
            <td> المبلغ المسحوب بالارقام</td>
        </tr>
        <tr>
            <td><asp:Label ID="lblwithamountstr" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False" ></asp:Label></td>
             <td><asp:TextBox ID="txtwithamountstr" runat="server" Width="280px"></asp:TextBox></td>
            <td> المبلغ المسحوب بالحروف</td>
        </tr>
        <tr>
           ...
           <td><asp:TextBox ID="txtbankid" runat="server" Width="280px"></asp:TextBox></td>
            <td>رقم حساب الساحب</td>
        </tr>
        <tr>
            <td><asp:Label ID="lblempname" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False" ></asp:Label></td>
             <td><asp:TextBox ID="txtempname" runat="server" Width="280px"></asp:TextBox></td>
             <td> اسم الموظف</td>
        </tr>
       <tr>
           <td><asp:Label ID="lbldate" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False" ></asp:Label></td>
            <td><asp:TextBox ID="txtdate" runat="server" Width="280px"></asp:TextBox></td>
             <td> تاريخ السحب</td>
        </tr>
    <tr>
            <td><asp:Label ID="lblrecphone" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False" ></asp:Label></td>
             <td><asp:TextBox ID="txtrecphone" runat="server" Width="280px"></asp:TextBox></td>
             <td> تليفون الساحب</td>
        </tr>
