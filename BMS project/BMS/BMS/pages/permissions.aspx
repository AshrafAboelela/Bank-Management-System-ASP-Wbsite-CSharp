<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="permissions.aspx.cs" Inherits="BMS.pages.permissions" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>Permissions - Bank Management System</title>
...
<asp:Panel ID="Panel1" runat="server" BorderWidth="1px" Width="191px">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -------------------------
    <asp:Button ID="btnaddclient" runat="server" Text="تسجيل العملاء" width="127px" style="margin-left: 38px;font-size:15px;" Height="27px" OnClick="btnaddclient_Click"/>
...
<div style="text-align:center;">
    <h3 style="background-color: #9999FF; width: 403px; height: 25px;">إضافة صلاحيات موظف</h3>
</div>
<table style="Width:405px; text-align: center; background-color: #99FF66;">
        ...
        <tr>
             <td><asp:Label ID="lblacc" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:CheckBox ID="acc" runat="server" /></td>
           <td>ادارة الحسابات</td>
        </tr>
        <tr>
             <td><asp:Label ID="lbltrns" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
           <td><asp:CheckBox ID="trns" runat="server" /></td>
            <td>ادارة الحوالات</td>
        </tr>
       <tr>
            <td><asp:Label ID="lblbox" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:CheckBox ID="box" runat="server" /></td>
            <td>ادارة الخزينة والصناديق</td>
        </tr>
        <tr>
             <td><asp:Label ID="lblcards" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:CheckBox ID="cards" runat="server" /></td>
            <td>ادارة البطاقات</td>
        </tr>
            <tr>
             <td><asp:Label ID="lblemp" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:CheckBox ID="emp" runat="server" /></td>
            <td>ادارة شئون الموظفين</td>
        </tr>
        <tr>
           <td></td>
