<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deposits.aspx.cs" Inherits="BMS.pages.deposits" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>Deposits - Bank Management System</title>
...
<div style="text-align:center;">
    <h3 style="background-color: #9999FF; width: 403px; height: 25px;">إجراء حركة إيداع</h3>
</div>
<table style="Width:405px; text-align: center; background-color: #99FF66;">
        <tr>
            <td><asp:Label ID="lbldepno" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
            <td><asp:TextBox ID="txtdepno" runat="server" Width="243px"></asp:TextBox></td>
            <td>المبلغ المودع بالارقام</td>
        </tr>
        <tr>
             <td><asp:Label ID="lbldepstr" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
           <td><asp:TextBox ID="txtdepstr" runat="server" Width="243px"></asp:TextBox></td>
            <td>المبلغ المودع بالاحرف</td>
        </tr>
        <tr>
        ...
        <tr>
           ...
           <td><asp:TextBox ID="txtbankid" runat="server" Width="243px"></asp:TextBox></td>
            <td>رقم حساب المودع</td>
        </tr>
            <tr>
             <td><asp:Label ID="lbldepname" runat="server" Text="*" Font-Size="15px" ForeColor="Red" Visible="False"></asp:Label></td>
           <td><asp:TextBox ID="txtdepname" runat="server" Width="243px"></asp:TextBox></td>
            <td>اسم المودع</td>
        </tr>
       <tr>
