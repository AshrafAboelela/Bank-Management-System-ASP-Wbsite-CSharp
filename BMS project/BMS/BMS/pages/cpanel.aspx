<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpanel.aspx.cs" Inherits="BMS.pages.cpanel" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>CPanel - Bank Management System</title>
...
<!-- client area -->
<form runat="server" id="form1" style="position:relative; top: 7px; left: 0px; height: 601px;">
...
<asp:Panel ID="Panel1" runat="server" BorderWidth="1px" Width="191px">
    ...
    <asp:Button ID="btninternet" runat="server" Text="اصدار انترنت" width="127px" style="margin-left: 38px;font-size:15px;" />
    <br />
...
<div id="client_area" style="position:relative; top:-554px; left:302px; width:406px; height:551px;">

</div>
<div id="clientarea0" style="position:relative; top:-1108px; left:18px; width:196px; height:564px;">
</div>
</form>
