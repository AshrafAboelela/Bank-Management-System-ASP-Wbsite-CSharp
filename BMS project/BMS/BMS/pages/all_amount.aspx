<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all_amount.aspx.cs" Inherits="BMS.pages.all_amount" %>
...
<head runat="server">
<meta charset="UTF-8" />
<title>All Amount - Bank Management System</title>
...
<li><a href="../site_map.aspx"><span>خريطة الموقع</span></a></li>
<li><a href="../control_panel.aspx"><span>لوحة تحكم الموظفين</span></a></li>
...
<div>
<img alt=""  style=" width:1000px; height:100px;" src="../images/bms.png" />
</div>
...
<div id="client_area" style="position:relative; top:-567px; left:217px; width:578px; height:542px;">
    <table style="width: 575px; margin-left: 15px; text-align:center">
           <tr>
            <td style="font-size: x-large; color: #0000FF">من فضلك ادخل الرقم القومى للعميل</td>
        </tr>
        <tr>
            <td><asp:TextBox ID="txtid" runat="server" Width="262px" AutoPostBack="True"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Button ID="btngetamount" runat="server" Text="بحث" Width="259px" OnClick="btngetamount_Click" /></td>
        </tr>
        <tr>
            <td >
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="553px" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="personal_id" HeaderText="personal_id" SortExpression="personal_id" />
                        <asp:BoundField DataField="rec_name" HeaderText="rec_name" SortExpression="rec_name" />
                        <asp:BoundField DataField="branchrec" HeaderText="branchrec" SortExpression="branchrec" />
                        <asp:BoundField DataField="transfer_type" HeaderText="transfer_type" SortExpression="transfer_type" />
                        <asp:BoundField DataField="daterec" HeaderText="daterec" SortExpression="daterec" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bankingConnectionString %>" SelectCommand="SELECT [personal_id], [rec_name], [branchrec], [transfer_type], [daterec], [amount] FROM [recevied_transfer] WHERE ([personal_id] = @personal_id)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtid" Name="personal_id" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>     
