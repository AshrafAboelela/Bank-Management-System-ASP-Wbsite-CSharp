<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error.aspx.cs" Inherits="BMS.pages.error" %>
...
<!-- client area -->    
<form runat="server" id="form1" style="position:relative; top: 7px; left: 0px; height: 69px; width: 990px;">

<div style="text-align:center;">
    <h3 style="background-color: #9999FF; width: 980px; height: 25px;">عفوا لا توجد هذه البيانات يرجى المحاولة</h3>
</div>
<div style="text-align:center;">
    <asp:Button ID="btnsend" runat="server" Text="عودة" Width="97px" OnClick="btnsend_Click"/>
</div>
</form>
